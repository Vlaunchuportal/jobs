					...
					<div class="row">
							...
							<div class="single-price no-padding">
								...
								<div class="price-bottom">
									<div class="price-wrap d-flex flex-row justify-content-center">
										<span class="price">Rs</span><h1> 390 </h1><span class="time">Per <br> Month</span>
									</div>
									<a href="payemnt.php" class="primary-btn header-btn">Get Started</a>
								</div>
						...
						<div class="col-lg-4">
							<div class="single-price no-padding">
								...
								<div class="price-bottom">
									<div class="price-wrap d-flex flex-row justify-content-center">
										<span class="price">RS</span><h1> 690 </h1><span class="time">Per <br> Month</span>
									</div>
						...
						<div class="col-lg-4">
							<div class="single-price no-padding">
								...
								<div class="price-bottom">
									<div class="price-wrap d-flex flex-row justify-content-center">
										<span class="price">Rs</span><h1> 999 </h1><span class="time">Per <br> Month</span>
									</div>
									<a href="#" class="primary-btn header-btn">Get Started</a>
								</div>
							</div>				
