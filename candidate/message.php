...
if(isset($_REQUEST['submitmail'])) {
        // checking of emptly field
            ...
            $cemail = $_REQUEST['remail'];
            $remail = $_REQUEST['cemail'];
            $message = $_REQUEST['message'];
            
    
            $sql= "INSERT INTO mail(email, cemail, canmessage, jobid, jobname, posted) VALUES('$remail', '$cemail', '$message', '$jobid', '$jobname', 'candidate')";
                ...
                <div class="row mx-7 text-center">  
                    <div class="col-sm-9 mt-5 text-center ">
                                ...
                                if(isset($_REQUEST['connect'])){
                                    $sql = "SELECT * FROM jobs WHERE jid = {$_REQUEST['connectid']} ";
                                ...
                                <form action="" method="POST" >
                                    ...
                                    <div class="form-group" style="text-align: left;">
                                        ...
                                        <input type="hidden" name="jobid" id="jobid" value="<?php echo $jid; ?>">
                                    </div>
                                    <div class="form-group" style="text-align: left;">
                                        <label for="job_title">From :</label>
                                        <input type="text" class="form-control" id="remail" name="remail" value="<?php echo $ceemail; ?>" readonly><br>
                                    </div>
                                    <div class="form-group" style="text-align: left;">
                                        <label for="job_skills">To :</label>
                                        <input type="text" class="form-control" id="cemail" name="cemail" value="<?php echo $m; ?>" readonly><br>
                                    </div>
                                    <?php
                                    ...
                                    <div class="form-group" style="text-align: left;">
                                        ...
                                        <textarea class="form-control" id="message" name="message"  rows=8>Dear Recruiter, this is regarding <?php echo $bn;  ?> job</textarea><br>
                                    </div>
