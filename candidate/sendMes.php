				...
				<div class="container">
					<div class="row justify-content-center d-flex">
						<div class="col-lg-8 post-list">
							...
							$sql = "SELECT * FROM mail where posted = 'candidate'" ;
								...
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											...
											<button class="hidebtn" type="submit" name="view" value="view"><h4><?php echo $row['email']; ?></h4></button>
											</form>
