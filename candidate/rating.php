...
if(isset($_REQUEST['rate'])) {
    $sql = "SELECT * FROM jobs WHERE jid = {$_REQUEST['rateid']} ";
...
<div class="hey">
						...
						if(!empty($_REQUEST['rating'])) 
							...
							$sql= "INSERT INTO canrating (jobid, userid, rating, review) VALUES ('$jjj', '$cid', '$rating', '$rev')";
							if($conn -> query($sql) == TRUE) {
								...
								$sql="SELECT * FROM canrating where jobid = '$jjj' ";
								$result = $conn->query($sql);
								$bb = $result->num_rows;
								...
								$sql = "UPDATE jobs SET ratings = '$poll', rateno = '$bb' WHERE jid = '$jjj'";
								$result = $conn->query($sql);
