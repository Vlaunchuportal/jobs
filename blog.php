				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="contact.html">Blog</a></p>
						</div>											
					</div>
				</div>
			</section>
			<!-- End banner Area -->	
						...
						<div class="menu-content pb-60 col-lg-10">
							<div class="title text-center">
								<h1 class="mb-10">News Articles</h1>
								<p>Gets Updated Daily.</p>
							</div>
						</div>
					</div>
				<div class="container">
					<div class="row">
						<div class="col-lg-10 post-list blog-post-list">
							<div class="single-post">
								<img class="img-fluid" src="https://wallpapercave.com/dwp1x/wp7421172.png" alt="">
								<ul class="tags">
									<li><a href="#">HTML, </a></li>
							...
							<div class="single-post">
								<img class="img-fluid" src="https://wallpapercave.com/dwp1x/wp5070716.jpg" alt="">
								<ul class="tags">
								...
								<a href="blog-single.html">
									<h1>
										Javascript the power of all Rounder!
									</h1>
								</a>
									<p>
							...
							<div class="single-post">
								<img class="img-fluid" src="https://wallpapercave.com/wp/wp8725088.jpg" alt="">
								<ul class="tags">
								...
								<a href="blog-single.html">
									<h1>
										Mongodb is a non-relational database, where the data can be easily accessed.
									</h1>
								</a>
									<p>
						...
						<!--		<a href="#"><h4>HR Vlauncu</h4></a>-->
						<!--		<p>-->
						<!--			Welcome to Vlaunchu, the journey where you will start to love on every step you take from here!-->
						<!--		</p>-->
						<!--		<ul>-->
						<!--			<li><a href="#"><i class="fa fa-facebook"></i></a></li>-->
						<!--			<li><a href="#"><i class="fa fa-twitter"></i></a></li>-->
