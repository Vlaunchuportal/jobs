                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-text-block custom-border-radius-start">
                                <h2 class="text-white mb-3">VLaunchu helps you an easier way to get new job</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 ms-auto">
                            <div class="custom-border-btn-wrap d-flex align-items-center mt-lg-4 mt-2">
                                <a href="../cr.php" class="custom-btn custom-border-btn btn me-4">Candidate Signup</a>
                                <a href="../rr.php" class="custom-btn custom-border-btn btn me-4">Recruiter Signup</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-3">
                        <div class="d-flex align-items-center mb-4">
                            <img src="vv4.jpeg" class="img-fluid logo-image">
