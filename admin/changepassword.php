...
if(isset($_REQUEST['cpasswordButton'])){
    if($_REQUEST['lnewpassword'] == ""){
        $Msg ='<div class="alert alert-warning col-sm-6 ml-5 mt-2"></div>';
    } else {
        $sql = "SELECT * FROM admin1 where aemail = '$aemail'";
        $result = $conn->query($sql);
        if($result->num_rows == 1) {
            $rpassword = $_REQUEST['lnewpassword'];
            $sql = "UPDATE admin1 SET apassword = '$rpassword' where aemail = '$aemail'";
            ...
            <div class="col-sm-9 mt-5 text-center ">
                ...
                <?php
                    ...
                    <div class="form-group" style="text-align: left;>
                        ...
                        <input type="email" class="form-control" id="inputEmail" value="<?php echo $remail ?>" readonly><br>
                    </div>
                    <div class="form-group " style="text-align: left;">
