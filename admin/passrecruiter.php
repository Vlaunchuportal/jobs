...
if(isset($_REQUEST['change'])){
    ...
    if($_REQUEST['lnewpassword'] == ""){
        ...
        $sql = "SELECT * FROM recruiter where rid = {$_REQUEST['id']}";
        
        $result = $conn->query($sql);
        if($result->num_rows == 1) {
            $rpassword = $_REQUEST['clnewpassword'];
            $sql = "UPDATE recruiter SET rpassword = '$rpassword' where rid = $idd ";
            ...
            <div class="col-sm-9 mt-5 text-center ">
                ...
                <?php
                    ...
                    <div class="form-group" style="text-align: left;>
                        ...
                        <input type="email" class="form-control" id="inputEmail" value="<?php echo $row['remail']; ?>" readonly><br>
                    </div>
                    <div class="form-group " style="text-align: left;">
