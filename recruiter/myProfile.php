    ...
    <div class="row justify-content-center">
        <div class="col-md-7 col-lg-4 mb-5 mb-lg-0 wow fadeIn">
            <div class="card border-0 shadow">
                <img src="../img/<?php echo $row['rimage']; ?>" style=" border-radius: 300px; " alt="...">
                <div class="card-body p-1-9 p-xl-5">
                    <div class="mb-4">
                        <h3 class="h4 mb-0"><strong><?php echo $row['rname'];?></strong></h3>
                        <span class="text-primary">Recruiter</span>
                    </div>
                    <ul class="list-unstyled mb-4">
                        <li class="mb-3"><a href="#!"><i class="far fa-envelope display-25 me-3 text-secondary"></i>      <?php echo $row['remail'];?></a></li>
                        <li class="mb-3"><a href="#!"><i class="fas fa-mobile-alt display-25 me-3 text-secondary"></i>     <?php echo $row['rnum'];?></a></li>
                        <li><a href="#!"><i class="fas fa-map-marker-alt display-25 me-3 text-secondary"></i>     <?php echo $row['rcity'];?></a></li>
                    </ul>
        ...
        <div class="col-lg-8">
            <div class="ps-lg-1-6 ps-xl-5">
                        ...
                        <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0"><?php echo $row['reducation'];?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0"><?php echo $row['remail'];?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0"><?php echo $row['rexperience'];?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="wow fadeIn">
                    ...
                    <p class="mb-4"><?php echo $row['rskills'];?><br>
