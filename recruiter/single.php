...
if(isset($_REQUEST['view'])){
    $sql = "SELECT * FROM candidate WHERE cid = {$_REQUEST['viewid']} ";
					...
					<div class="row justify-content-center d-flex">
						<div class="col-lg-8 post-list">
							<div class="single-post d-flex flex-row">
								<div class="thumb">
									<img src="../img/<?php if(isset($row['cimage'])){ echo $row['cimage'];}?>" style=" width: 70px; height: 70px; border-radius: 150px; " alt="">
									<ul class="tags">
										<li>
											<a href="#">Art</a>
										</li>
								...
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="#"><h4><?php if(isset($row['cname'])){ echo $row['cname'];}?></h4></a>
											<h6><?php if(isset($row['cskills'])){ echo $row['cskills'];}?></h6>					
										</div>
										<ul class="btns">
									...
									<p>
									<?php if(isset($row['cexperience'])){ echo $row['cexperience'];}?>
									</p>
									<h5>Job Nature: Full time</h5>
									<p class="address"><span class="lnr lnr-map"></span>  <?php if(isset($row['ccity'])){ echo $row['ccity'];}?></p>
									<p class="address"><span class="lnr lnr-database"></span>  <?php if(isset($row['ceducation'])){ echo $row['ceducation'];}?></p>
								</div>
							</div>	
						...
						<div class="col-lg-4 sidebar">
                            ...
                            <input type="hidden" name="rateid" value="<?php echo $row['cid']; ?> ">
                            <button type="submit" class="btn btn-info" name="rate" value="Rate">Rate this Candidate</button>
                            </form>
                            ...
                            <input type="hidden" name="reportid" value="<?php echo $row['cid']; ?> ">
                            <button type="submit" class="btn btn-info" name="report" value="report">Report this Candidate</button>
                            </form>
