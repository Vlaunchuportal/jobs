...
?>
			...
			<!-- start banner Area -->
			<section class="banner-area relative" style="  height:740px; " id="home">	
							...
							<form action="" class="serach-form-area">
								<div class="row justify-content-center form-wrap">
									<div class="col-lg-10 form-cols">
										<input type="text" class="form-control" name="idd" id="idd" style=" border-radius: 40px; " placeholder="Job Title">
									</div>
                                     <br><br><br>
									...
									<div class="col-lg-5 form-cols"  style="  height: 45px; " >
									    <button type="submit" name="search" value="search" style=" border-radius: 40px; " class="btn btn-info">
